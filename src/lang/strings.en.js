...
module.exports = {
  ...
  CASE_OPEN: `📦 Today is your lucky day!${escapeCharacter}💰 $ from the crate:`,
  TOTAL_AMOUNT: "💰 Total reserve in the central bank:",
  BANK_INFO: `${escapeCharacter}${escapeCharacter}ℹ️ This money is equivalent to the total money in the state. If it runs out, salaries cannot be paid, market prices increase, and people may revolt.${escapeCharacter}${escapeCharacter}💰 $ is generated in two ways: by the number of messages sent within the group during the day, and automatically by a certain money generation rate. The second way is through purchases on the market or through taxes.`,
  URL_FORBIDDEN: "🔴 It has been detected that you shared a URL. To share URLs, you must purchase the link sharing package from /wallet.",
  IMAGE_FORBIDDEN: "🔴 It has been detected that you shared an image. To share images, you must purchase the image sharing package from /wallet.",
  STICKER_FORBIDDEN: "🔴 It has been detected that you shared a sticker. To share stickers, you must purchase the sticker sharing package from /wallet.",
  BADWORD_FORBIDDEN: "🔴 It has been detected that you shared a swear word. To share swear words, you must purchase the swear word sharing package from /wallet.",
